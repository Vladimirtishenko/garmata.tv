...
<div class="all_posts_page">
    <div class="right_all_posts_page">
        <p><span><span class="glyphicon glyphicon-calendar"></span> &nbsp; <?= date('d-m-Y H:m', strtotime($data->date)); ?> | </span> <?= CHtml::encode($data->author->name); ?></p>
        ...
        <p><span class="glyphicon glyphicon-comment"></span> &nbsp; <?= Yii::t('main', 'Перегляди'); ?>: <?= CHtml::encode($data->views); ?></p>
