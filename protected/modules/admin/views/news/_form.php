        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <?= $form->textField($model,'author',array('size'=>60,'maxlength'=>150, 'class'=>'form-control')); ?>
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <?= $form->textField($model,'tags',array('size'=>60,'maxlength'=>255, 'class'=>'form-control')); ?>
                    <?= $form->error($model,'tags'); ?>
                </div>

                <div class="form-group">
                    <?= $form->labelEx($model,'marker'); ?>
                    <?= $form->textField($model,'marker', array('class'=>'form-control')); ?>
                    <?= $form->error($model,'marker'); ?>
                </div>
