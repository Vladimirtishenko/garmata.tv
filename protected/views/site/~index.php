...
<div class="streamBlock">
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane fade" id="stream2">
            <p><?= Yii::app()->language == 'ru' ? Streem::model()->findByPk(2)->name_ru : Streem::model()->findByPk(2)->name_uk; ?></p>
            <iframe width="100%" height="270px" src="<?= Streem::model()->findByPk(2)->url; ?>" frameborder="0" allowfullscreen></iframe>
      </div>
    </div>
</div>
