<?php if(empty($searchNews->data) && empty($searchPhotos->data) && empty($searchVideos->data)): ?>
    ...
    <div class="forBlogH3">
        <h3><?= Yii::t('main', 'Результати пошуку'); ?></h3> <span class="glyphicon glyphicon-play"></span>
    </div>
    <div class="new-class">
...
<?php if(!empty($searchPhotos->data)): ?>
    <div class="forBlogH3">
        <h3><?= Yii::t('main', 'Результати пошуку'); ?></h3> <span class="glyphicon glyphicon-play"></span> <a><?= Yii::t('main', 'Фоторепортажі'); ?></a>
    </div>
    <?php
    $this->widget('zii.widgets.CListView', array(
...
<div class="forBlogH3">
    <h3><?= Yii::t('main', 'Результати пошуку'); ?></h3> <span class="glyphicon glyphicon-play"></span> <a><?= Yii::t('main', 'Відеосюжети'); ?></a>
</div>
