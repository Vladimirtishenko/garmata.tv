var currensy = (function() {
    ...
    function templateForArray(a) {
        ...
        var str = "<table class='-new-currensy'><tr class='th-title'><td><span>Банк</span></td><td><span style='font-size: 18px'>&#402;</span></td><td><span>Покупка</span></td><td><span>Продажа</span></td></tr>";
        ...
        var div = document.querySelector(".-this-currency-state");
